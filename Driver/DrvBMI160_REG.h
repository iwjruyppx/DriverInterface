...
#ifndef __DRV_BMI160_REG_H__
#define __DRV_BMI160_REG_H__
...
//#define BMI160_DUMP_GYRO_CONFIG

#ifdef FULL_SCALE_USE_2G
#define ACC_RANGE_CONVERT ACC_RANGE_2G_CONVERT
#elif defined(FULL_SCALE_USE_4G)
#define ACC_RANGE_CONVERT ACC_RANGE_4G_CONVERT
#elif defined(FULL_SCALE_USE_8G)
#define ACC_RANGE_CONVERT ACC_RANGE_8G_CONVERT
#elif defined(FULL_SCALE_USE_16G)
#define ACC_RANGE_CONVERT ACC_RANGE_16G_CONVERT
#endif
    
#ifdef FULL_SCALE_USE_2000DPS
#define GYR_DPS_CONVERT    GYR_RANGE_2000DPS_CONVERT
#elif defined(FULL_SCALE_USE_1000DPS)
#define GYR_DPS_CONVERT    GYR_RANGE_1000DPS_CONVERT
#elif defined(FULL_SCALE_USE_500DPS)
#define GYR_DPS_CONVERT    GYR_RANGE_500DPS_CONVERT
#elif defined(FULL_SCALE_USE_250DPS)
#define GYR_DPS_CONVERT    GYR_RANGE_250DPS_CONVERT
#elif defined(FULL_SCALE_USE_125DPS)
#define GYR_DPS_CONVERT    GYR_RANGE_125DPS_CONVERT
#endif

#endif /* __DRV_BMI160_REG_H__ */
